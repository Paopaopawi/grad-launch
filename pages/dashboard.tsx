...
import LearningResources from "../component/learningResources";
        ...
        >
          <div className="container my-5">
            <h2 className="text-center mb-4">
              Your First Step Into the Tech World Starts Here
            </h2>
          ...
          {/* Tips Section*/}
          <div className="row mt-1" id="tips-section">
          ...
          {/* Learning Section*/}
          <div className="row mt-1" id="learning-section">
            <div className="col-12">
              <LearningResources />
            </div>
          </div>
